    ...
    return (
      <article className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 overflow-hidden hover:shadow-md transition-shadow">
        ...
        <div className="p-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3 font-hindi leading-tight">
            {article.titleHindi}
          </h3>
          <p className="text-gray-600 mb-4 font-hindi leading-relaxed">
            {article.excerptHindi}
          </p>
          <a href={`#article-${article.id}`} className="text-red-600 font-semibold hover:text-red-700 font-hindi">
            पूरी खबर पढ़ें →
          </a>
        </div>
      </article>
    ...
    <article className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      <div className="flex">
        ...
        <div className="p-4 flex-1">
          ...
          <h3 className="text-base font-bold text-gray-900 mb-2 font-hindi leading-tight">
            {article.titleHindi}
          </h3>
