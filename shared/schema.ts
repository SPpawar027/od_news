...
export const liveStreams = pgTable("live_streams", {
  ...
  streamType: text("stream_type").notNull(), // m3u8, youtube, custom
...
export const rssFeeds = pgTable("rss_feeds", {
  ...
  fetchFrequency: integer("fetch_frequency").default(30), // in minutes
...
export const rssItems = pgTable("rss_items", {
  ...
  importedAsArticleId: integer("imported_as_article_id").references(() => articles.id),
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const videos = pgTable("videos", {
  ...
  categoryId: integer("category_id").references(() => categories.id),
  isVertical: boolean("is_vertical").default(true),
